#### THIS CODE IS FROM https://github.com/chasinginfinity/number-sign-recognition/blob/master/collect-data.py with a few modifications
...
while True:
    ...
    cv2.putText(frame, "MODE : "+mode, (10, 50), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,0), 1)
